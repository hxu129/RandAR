...
torchrun --nproc_per_node=4 $PROJECT_DIR/sample_corrector.py \
    ...
    --corrector-ckpt "${DATA_PATH}/corrector-results/test-pipeline_bs_768_lr_0.0001/checkpoints/iters_00004500/model.safetensors" \
    --cfg-scales 1.0,4.0 \
