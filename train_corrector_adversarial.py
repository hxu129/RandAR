...
def perturb_image_tokens_with_randar(
...
def main(args):
    ...
    while train_steps < total_iters:
        ...
        with accelerator.accumulate(corrector):
            ...
            perturbed_tokens, perturbed_indices = perturb_image_tokens_with_randar(
                gpt,
                permuted_image_tokens,
                cond,
                token_order,
                perturb_ratio=config.training_params.get('perturb_ratio', 0.2),
                perturb_num=config.training_params.get('perturb_num', 1),
                perturb_mode=config.training_params.get('perturb_mode', 'ratio')
            )
